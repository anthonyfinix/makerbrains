...
function estore_finix_after_single_product()
{
	echo '</div>';
}
add_action('woocommerce_after_single_product', 'estore_finix_after_single_product', 9);
...
function estore_finix_after_single_product_summary()
{
	echo "</div>";
}
